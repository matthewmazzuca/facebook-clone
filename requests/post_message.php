...
?>
<?php if($x == 1) { ?>
<script language="javascript" type="text/javascript">window.top.window.stopUpload('<?php echo $feed->postMessage($_POST['message'], $_FILES['my_image'], $_POST['type'], $_POST['value'], $_POST['privacy'], $_POST['group']); ?>');</script>
<?php } else { ?>
